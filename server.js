...
app.put('/news/:id', (req, res) => {
  ...
  News.update({'id' : req.params.id}, {$set: {'author' : req.body.author, 'title': req.body.title}}).then(news => res.send(news));
  res.sendStatus(200);
...
app.delete('/news/:id', (req, res) => {
  ...
  // });
  News.remove({'id': req.params.id}).then(news => res.send(news));
  res.sendStatus(200);
